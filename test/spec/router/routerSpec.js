...
//      $templateCache.put('quiz/info/quizInfo.html','');
//      $templateCache.put('quiz/questionA/questionA.html','');
//
//    });
//
//
...
//        expect($state.current.name).to.equal('app.welcome');
//      });
//    });
//
...
//        goTo('/quiz/info');
//        expect($state.current.name).to.equal('app.quiz.info');
//      });
//
...
//    //    expect($state.current.name).to.equal('app.quiz.questions.a');
//    //  });
//    //});
//
...
//        expect($state.current.name).to.equal('app.quiz.questions.a.level0');
//      });
//    });
//
...
//        expect($state.current.name).to.equal('app.quiz.questions.a.level1');
//      });
//    });
//
...
//        expect($state.current.name).to.equal('app.quiz.questions.a.level2');
//      });
//    });
//
//
